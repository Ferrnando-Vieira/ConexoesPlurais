...
function to_info() {
    if (now === 0) {
        ...
        document.getElementById('anim-2').innerHTML='O evento será dividido em dois Paineis. O primeiro o qual os convidados são CEOs, sócios e diretores de empresas no meio digital.';
